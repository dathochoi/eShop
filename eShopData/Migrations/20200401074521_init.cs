        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscaountAmout = table.Column<int>(nullable: true),
                    DsicaoutnAmout = table.Column<decimal>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 4, 1, 14, 45, 21, 173, DateTimeKind.Local).AddTicks(6925)),
                    UserId = table.Column<Guid>(nullable: false),
                    ...
                    OrderSatus = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amout = table.Column<decimal>(nullable: false),
